...
export default function DashboardPage() {
  ...
  async function handleCreateProject(e: React.FormEvent) {
    ...
    try {
      ...
      // Refresh list then close after short delay
  ...
  return (
    <>
      <style>{`
        ...
        .db-avatar { width:32px; height:32px; border-radius:50%; background:linear-gradient(135deg,#0078FF,#00C8FF); display:flex; align-items:center; justify-content:center; font-size:11px; font-weight:700; color:#fff; cursor:pointer; flex-shrink:0; }
        ...
        .modal-topbar {
          height:3px;
          background:linear-gradient(90deg,#0078FF,#00C8FF,#00D97A);
        }
        ...
        .modal-error {
          ...
          border:0.5px solid rgba(220,50,50,0.22);
        ...
        .modal-success {
          ...
          border:0.5px solid rgba(0,200,100,0.22);
          border-radius:8px; padding:10px 13px;
          font-size:12px; color:#00D97A;
        }
      ...
      <div className='db-page'>
        ...
        <nav className='db-nav'>
          ...
          <div className='db-nav-right'>
            ...
            <div className='db-avatar' title='Profile'>
              PM
            </div>
          </div>
        </nav>
